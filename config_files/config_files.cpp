...
void config_Files::writeToFile(const std::string& dir, const std::string &path, const std::string &value)
{
    [](std::string d)->int {
#ifdef _WIN32
...
std::string config_Files::readFromFile(const std::string& dir, const std::string &path, const std::string &def  )
{
    std::string line;
    std::string ret;
    std::string pathFile =    path;
